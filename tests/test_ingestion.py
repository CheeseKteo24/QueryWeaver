...
class ChunkDocumentTests(unittest.TestCase):
    def test_chunk_ids_are_deterministic(self) -> None:
        first = chunk_document("policy", "Returns last 30 days. Shipping takes 2 days.", max_words=5)
        second = chunk_document("policy", "Returns last 30 days. Shipping takes 2 days.", max_words=5)
